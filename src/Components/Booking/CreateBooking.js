                  ...
                  >
                    ...
                    {deals.map((deal, index) => (
                      <option
                        ...
                        title={`${deal.dealName} - ${
                          deal.dealPrice
                        }$ [${deal.dealItems.map((item) => item.dishName)}]`}
                      >
                        {`${deal.dealName} - ${deal.dealPrice}`}
                      </option>
                    ))}
                  </Form.Select>
                    ...
                    >
                      ...
                      {caterers?.map((caterer, idx) => (
                        <option
                          ...
                          key={idx}
                        >
                          {caterer?.userName} - ${caterer?.serviceCharges}
                        </option>
                      ))}
                    </Form.Select>
        ...
        >
          {!isNaN(totalPrice) && totalPrice !== 0 && (
            <div className="d-flex flex-column">
              <p className="fs-4">
                Total Price: <Badge bg="warning">{`${totalPrice}/-`}</Badge>
              </p>
            </div>
          )}
        </Col>
