...
const CreateCustomDeal = ({ handleModal }) => {
  ...
  const handleTagChange = (tags) => {
    let totalPrice = tags.reduce((accumulator, currentValue) => {
      return accumulator + Number.parseInt(currentValue.split('-')[1]);
    }, 0);
    ...
    formik.setFieldValue('dealPrice', totalPrice);
  };
          ...
          <Form onSubmit={handleSubmit} className="w-100">
            ...
            <Form.Group className="mb-3" controlId="formBasicPassword">
              ...
              <Form.Select
                ...
                name="dealItems"
              >
                <option value="">Choose Dishes</option>
              ...
              <TagsInput
                value={formik.values.dealItems.map((item) =>
